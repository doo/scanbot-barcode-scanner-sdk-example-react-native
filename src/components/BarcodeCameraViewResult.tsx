  ...
  return (
    <View style={[styles.resultsView, props.style]}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity style={styles.button} activeOpacity={0.6} onPress={props.onFinderToggle}>
          <Image source={require('../assets/ic_finder_view.png')} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} activeOpacity={0.6} onPress={props.onFlashToggle}>
          <Image
            source={
              props.flashEnabled
